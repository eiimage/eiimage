...
//    GrayscaleImage* im = Converter<GrayscaleImage>::convert(*img);
    ...
    if(transformBox->currentIndex() == 0) {
        ...
        outDoubleImage(resImg, qApp->translate("Transforms", "Hadamard transform").toStdString(), DISABLE, DISABLE, false, 256., true);
        ...
        outDoubleImage(resImg, qApp->translate("Transforms", "Haar transform").toStdString(), DISABLE, DISABLE, false, 256., true);
        ...
        outDoubleImage(resImg, qApp->translate("Transforms", "cosinus transform").toStdString(), DISABLE, DISABLE, false, 256., true);
